		...
		if ( count($var) != 0 )
		{
			...
			foreach ($var as $key )
			{
				if( password_verify( $Contrasena, $key[ $CampoContrasena[$i] ] ) )
				{
					...
					$_SESSION['usuario_id']=$key['id'];
					$_SESSION['usuario_tipo']=$key['idtipusu'];
...
<html>
	<head>
		...
		<link rel="stylesheet" href="assets/css/main.css?rand=<?php echo rand(0,9999)?>" />
		<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.2.1/dist/css/bootstrap.min.css" rel="stylesheet"
    	integrity="sha384-iYQeCzEYFbKjA/T2uDLTpkwGzCiq6soy8tYaI1GyVh/UjpbCx/TYkiZhlZB6+fzT" crossorigin="anonymous">
		<link rel="icon" href="../img/nava.png">
			...
			<div id="wrapper">
				...
				<!-- Header -->
					<header id="header" class="alt">
						<span class="logo"><img src="./images/nava.svg"   alt="" /></span>
					...
					<section align="center">
						<form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
							<div class="row gtr-uniform">
								...
								<div class="col-12">
									<input name="btnIniciar" type="submit" value="Iniciar" class="primary" style="background-color:#F19319 !important" onclick="return inicio()" />
								</div>

								<div class="col-12">
									<a class="btn btn-primary" href="../index3.html">Regresar</a>
								</div>
